...
void get_password(char* ppassword)
{
    ...
    scanf("%s", ppassword);// since a display is not given to this local module, hiding password is not important
    //the project involves additional support features from a mobile app aswell
    return;
}
